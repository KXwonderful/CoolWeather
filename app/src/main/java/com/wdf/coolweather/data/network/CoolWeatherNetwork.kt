package com.wdf.coolweather.data.network

import com.wdf.coolweather.data.network.api.PlaceService
import com.wdf.coolweather.data.network.api.WeatherService
...
/**
 * Function:
 * Author: wonderful on 2020/1/13 14:58
 */
...
class CoolWeatherNetwork {
    ...
    suspend fun fetchBinPic() = weatherService.getBingPic().await()
        ...
        return suspendCoroutine { continuation ->
            enqueue(object : Callback<T> {
                ...
                override fun onResponse(call: Call<T>, response: Response<T>) {
                    ...
                    else continuation.resumeWithException(RuntimeException("response body is nul"))
                }
            })
        }
    }
